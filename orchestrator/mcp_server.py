...
def _diagnostic_guidance(project_root: str) -> str:
    ...
    lines.append("relay failures to the user. Diagnose and act first:")
    lines.append("")
    lines.append("1. Call get_pipeline_state() to read the interrupt_payload")
    lines.append("2. Check 'confidence' field:")
    lines.append("   - >= 0.7 with retries remaining: auto-retry")
    lines.append("     resume_pipeline(action='retry')")
    ...
    lines.append("5. Check 'needs_human' and 'confidence':")
