...
export default function HumanReviewNode({ data, selected }) {
  ...
  return (
    <div className={`workflow-node human-review-node ${selected ? 'selected' : ''}`}>
      <Handle type="target" position={targetPos} />
      <div className="node-header human-review-header">
