...
export default function DecideNode({ data, selected }) {
  ...
  return (
    <div className={`workflow-node decide-node ${selected ? 'selected' : ''}`}>
      <Handle type="target" position={targetPos} />
      <div className="node-header decide-header">
